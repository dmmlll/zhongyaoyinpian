...
if __name__ == '__main__':
    ...
    multipage=st.sidebar.radio("查询",('中药饮片','中医方剂'))
    if multipage=='中药饮片':
        ...
        source2_index = st.sidebar.radio("查询", range(len(source2)), format_func=lambda x: source2[x])
        st.info('三、*中药饮片！*:sunglasses:')
        #st.info("中药饮片大全")
        if source2_index == 0:
            # 加载图片
        ...
        st.info('四、*处方！*:sunglasses:')
        #st.info("症状处方")
        # 第三个框，处方
        source3 = ('辛温解表', '发烧', '新冠中药预防')
        # sidebar侧边栏
        ...
        if source3_index == 0:
            ...
            st.markdown('''
            普通人群预防：可选用黄芪12g、炒白术9g、防风6g、金银花9g、连翘9g、桑叶6g、炒牛蒡子6g、芦根9g、炙甘草3g以益气固表，清热解毒。\n
